...
public class Client123 implements Interface1,Interface2,Interface3 {
    ...
    public static void main(String[] args) {
        ...
        client123.methodA(); //Resolves to child Interface Implementation if methodA in Client123 is not present
        client123.methodB(); //If we add methodB to interface3 then it will be executed as its child interface
        client123.methodC();
